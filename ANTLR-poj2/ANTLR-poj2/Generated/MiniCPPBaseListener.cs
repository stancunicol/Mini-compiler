...
public partial class MiniCPPBaseListener : IMiniCPPListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterConsructorDecl([NotNull] MiniCPPParser.ConsructorDeclContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MiniCPPParser.consructorDecl"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitConsructorDecl([NotNull] MiniCPPParser.ConsructorDeclContext context) { }
	/// <summary>
